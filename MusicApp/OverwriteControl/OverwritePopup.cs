...
{
    public class OverwritePopup: Popup
    {
        ...
        public static readonly DependencyProperty IsPositionUpdateProperty =
            DependencyProperty.Register("IsPositionUpdate", typeof(bool), typeof(OverwritePopup), new PropertyMetadata(true, new PropertyChangedCallback(IsPositionUpdateChanged)));

        private static void IsPositionUpdateChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as OverwritePopup).pup_Loaded(d as OverwritePopup, null);
        }

        /// <summary> 
        /// 加载窗口随动事件 
        /// </summary> 
        public OverwritePopup()
        {
        ...
        {
            (obj as OverwritePopup).UpdateWindow();
        }
